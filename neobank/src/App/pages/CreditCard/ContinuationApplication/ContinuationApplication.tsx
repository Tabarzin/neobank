...
import WaitDecision from './WaitDecision/WaitDecision';
...
//   const handleFieldChange = (name: keyof ContinuationFormData, value: any) => {
//     dispatch(setFormData({ ...savedFormData, [name]: value } as ContinuationFormData));
//   };
...
//                     handleFieldChange('dependentAmount', e.target.value);
//                   }}
...
//                     handleFieldChange('workExperienceTotal', e.target.value);
//                   }}
...
//                     handleFieldChange('workExperienceCurrent', e.target.value);
//                   }}
